...
async function translateSections(selectedLanguage) {
  ...
  document.querySelectorAll(".trans__contact__call-now").forEach(element => {element.innerHTML =  data.contact.cnow[selectedLanguage]});
  document.getElementById('contact__chat').innerHTML = data.contact.chat[selectedLanguage];
  document.getElementById('contact__chat-now').innerHTML = data.contact.chnow[selectedLanguage];
  document.getElementById('contact__reserve').innerHTML = data.contact.reserve[selectedLanguage];
  document.getElementById('contact__reserve-now').innerHTML = data.contact.rnow[selectedLanguage];  
